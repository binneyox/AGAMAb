/* Integrates an orbit in a flattened Hernquist potential and use both
 * the TG action finder and the Fudge action finder to compute actions
 * along the orbit
 */
...
int main(void){
	...
	actions::ActionFinderTG AFTG(pot,TG,&AF);
	printf("        TG           Fudge\n   Jr       Jz       Jr       Jz\n");
