...
EXP ComponentWithSpheroidalDF::ComponentWithSpheroidalDF(
...
EXP void ComponentWithSpheroidalDF::update(
...
EXP ComponentWithDisklikeDF::ComponentWithDisklikeDF(
    const df::PtrDistributionFunction& df,
    const potential::PtrDensity& initDensity,
    unsigned int _mmax,
...
EXP void ComponentWithDisklikeDF::update(
    const potential::BasePotential& totalPotential,
    const actions::BaseActionFinder& actionFinder)
{
