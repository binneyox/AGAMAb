...
class EXP ComponentStatic: public BaseComponent {
public:
...
*/
class EXP BaseComponentWithDF: public BaseComponent {
public:
...
class EXP ComponentWithSpheroidalDF: public BaseComponentWithDF {
public:
...
class EXP ComponentWithDisklikeDF: public BaseComponentWithDF {
public:
...
typedef EXP shared_ptr<BaseComponent> PtrComponent;
...
*/
struct EXP SelfConsistentModel {
public:
...
*/
EXP void doIteration(SelfConsistentModel& model);
