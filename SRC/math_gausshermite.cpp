...
inline EXP std::vector<double> computeGaussHermiteMoments(const IFunction& fnc,
...
EXP GaussHermiteExpansion::GaussHermiteExpansion(const IFunction& fnc,
    unsigned int order, double ampl, double center, double width) :
...
template EXP GaussHermiteExpansion::GaussHermiteExpansion(const BsplineWrapper<0>&, unsigned int, double, double, double);
template EXP GaussHermiteExpansion::GaussHermiteExpansion(const BsplineWrapper<1>&, unsigned int, double, double, double);
template EXP GaussHermiteExpansion::GaussHermiteExpansion(const BsplineWrapper<2>&, unsigned int, double, double, double);
template EXP GaussHermiteExpansion::GaussHermiteExpansion(const BsplineWrapper<3>&, unsigned int, double, double, double);


EXP double GaussHermiteExpansion::value(const double x) const
{
...
EXP double GaussHermiteExpansion::normn(unsigned int n)
{
...
EXP double GaussHermiteExpansion::norm() const {
    double result = 0;
...
EXP Matrix<double> computeGaussHermiteMatrix(int N, const std::vector<double>& grid,
    unsigned int order, double ampl, double center, double width)
{
    switch(N) {
